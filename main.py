...
def check_availability():
    ...
    try:
        ...
        # CLICK OFFERS TAB (fixed)
        offers_tab = driver.find_element(By.XPATH, "//a[contains(., 'Offers')]")
        driver.execute_script("arguments[0].click();", offers_tab)
        time.sleep(6)  # wait for content to load

        # GET PAGE TEXT
        body_text = driver.find_element(By.TAG_NAME, "body").text
        print("📄 Offers snippet:", body_text[:500])
        ...
        if "Show first available offer" in body_text:
            ...
            print("⚠️ Unknown state - check manually")
